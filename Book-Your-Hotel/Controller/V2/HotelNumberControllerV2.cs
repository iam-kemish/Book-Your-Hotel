...
namespace Book_Your_Hotel.Controller.V2
{
    [Route("api/v{version:apiVersion}/HotelNumbers")]
    [ApiController]
    [ApiVersion("2.0")]
    public class HotelNumberControllerV2 : ControllerBase
    {
        private readonly IHotelNoRepo _IHotelNo;
        private readonly ILogger<HotelControllerV2> _logger;
        private readonly APIResponse response;
        private readonly IMapper _IMapper;
        private readonly IHotelRepo _IHotel;

        public HotelNumberControllerV2(IHotelNoRepo hotelNoRepo, ILogger<HotelControllerV2> logger, IMapper mapper, IHotelRepo iHotel)
        {
